...
Month and temperature and high temperature, precipitation
...
geom map, geom smoothm, geom histogram
...
ggplot(weather_clean, aes(x = dateInYear)) +
  geom_linerange(aes(ymin = RecordLow, ymax = RecordHigh), color = "grey") +
    theme_classic()
```
...
I added 15 days to the month.starts variable, and used month.abb to label them.
